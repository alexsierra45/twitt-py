...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EditUser = channel.unary_unary(
                ...
                request_serializer=users__pb2.EditUserRequest.SerializeToString,
                response_deserializer=users__pb2.EditUserResponse.FromString,
                _registered_method=True)
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'EditUser': grpc.unary_unary_rpc_method_handler(
                    servicer.EditUser,
                    request_deserializer=users__pb2.EditUserRequest.FromString,
                    response_serializer=users__pb2.EditUserResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def EditUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/twittpy.UserService/EditUser',
            users__pb2.EditUserRequest.SerializeToString,
            users__pb2.EditUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
